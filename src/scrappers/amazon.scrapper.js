...
import { scrapProductSchema, } from "../schemas/scrap-product.schema.js";
...
export async function scrapeAmazon(url) {
    ...
    const memory = $("#inline-twister-expanded-dimension-text-size_name").text().trim() ||
        undefined;
    const color = $("#inline-twister-expanded-dimension-text-color_name").text().trim() ||
        undefined;
    const imageUrl = $("#imgTagWrapperId img").attr("src") ?? $("#landingImage").attr("src");
...
//# sourceMappingURL=amazon.scrapper.js.map